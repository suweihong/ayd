...
<div class="storemenu1">
	...
	<a href="{{route('fields.index')}}?store_id={{$store_id}}" @if($shadow == 2) class="active" @endif>销售</a>
	<a href="/store/orders?store_id={{$store_id}}" @if($shadow == 3) class="active" @endif>订单</a>
	<a href="{{route('estimates.index')}}?store_id={{$store_id}}" @if($shadow == 4) class="active" @endif>评价</a>
</div>
